...
<head>
	<meta charset="utf-8">
	<title>JKYochum</title>
	<link rel="shortcut icon" href="../../images/favicon.ico">
	<link rel="apple-touch-icon" href="../../images/apple-icon-180x180.png">
	<link rel="android-touch-icon" href="../../images/android-icon-192x192.png">
	<link rel="stylesheet" href="../../styles/main.css">
	<link rel="stylesheet" href="//code.jquery.com/ui/1.12.1/themes/base/jquery-ui.css">
	
	<script src="https://code.jquery.com/jquery-1.12.4.js"></script>
  	<script src="https://code.jquery.com/ui/1.12.1/jquery-ui.js"></script>
  	<meta name="author" content="Jeremy Yochum">
	<meta name="keywords" content="HTML, CSS, JavaScript, jQuery, C++, VB, Swift, Java, Unity, C#, ASP, SQL, PHP, Programmer">
	<meta name="description" content="Website by Jeremy Yochum. Programming and networking skills. VB, C++, HTML5, CSS3, JavaScript, C#, Swift, Java, SQL, PHP, ASP, Windows and iOS. Visit and get in contact!">
...
<body>
<header><a href="http://jkyochum.com">
<div id="image">

<!-- Generator: Adobe Illustrator 16.0.0, SVG Export Plug-In . SVG Version: 6.00 Build 0)  -->
<!DOCTYPE svg PUBLIC "-//W3C//DTD SVG 1.1//EN" "http://www.w3.org/Graphics/SVG/1.1/DTD/svg11.dtd">
<svg version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" width="70px"
	 height="70px" viewBox="0 0 350 350" style="enable-background:new 0 0 350 350;" xml:space="preserve">
...
<div class="dropdown">
    <button onclick="myFunction()" class="dropbtn"><img id="arrow" src="../../images/white-down.png"></button>
      <div id="myDropdown" class="dropdown-content">
        <a href="../../index.html">Home</a>
        <a href="../../other_pages/resume/index.html">Resume</a>
      </div>
</div>
...
<div id="nav">
	<div id="nav-wrapper">
		<ul>
			<li><a href="../../index.html">Home<div id="home"><img src="../../images/home.png"></div></a>
			<li><a href="../resume/index.html">Resume<div id="resume"><img src="../../images/clipboard.png"></div></a></li>
		</ul>
	</div>
</div>

<form action="?" method="post" id="updateform">
        <h2 class="phpHeading">Edit user:</h2> 
        <p><a href="index.php" id="back">Go Back</a></p>
        <input type="hidden" name="id" value="<?php echo $users['id']; ?>">

      <div>
        <label for="updatedfirstname">First Name:</label>
        <input type="text" id="updatedfirstname" name="updatedfirstname" value="<?php if(isset($_POST['updatedfirstname'])){echo $_POST['updatedfirstname'];}else{echo $row['firstName'];} ?>"><span><?php echo $fname_err; ?></span>
      </div>
      <div>
          <div>
        <label for="updatedlastname">Last Name:</label>
          <input type="text" id="updatedlastname" name="updatedlastname" value="<?php if(isset($_POST['updatedlastname'])){echo $_POST['updatedlastname'];}else{echo $row['lastName'];} ?>"><span><?php echo $lname_err; ?></span>
      </div>
      <div>
        <label for="updatedemail">Email:</label>
        <input type="text" id="updatedemail" name="updatedemail" value="<?php if(isset($_POST['updatedemail'])){echo $_POST['updatedemail'];}else{echo $row['email'];} ?>"><span><?php echo $email_err; ?></span>
       </div>
      	<div id="btns">
        	<input type="submit" value="Update" id="updatingUser">
        </div>
    </form>
