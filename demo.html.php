...
<div id="phpdemo">
    <h2 class="phpHeading">PHP Demo</h2>
      <p><a href="../../index.html" id="back">Go Back</a></p>
      <table>
          <tr>
              <th>First Name</th>
              <th>Last Name</th>
		  ...
		  <?php foreach ($users as $user): ?>
     	  <form action="?deleteuser" method="post">
	        <tr>
               ...
               <td id="delete"> <input type="submit" value="Delete" id="deletebutton"></td>
               <td id="edit"> <?php $qstring="?id=".$user['id'];
       ...
       <?php endforeach; ?>
        ...
        <p><a href="?adduser" id="adduser">Add a User</a></p>
</div>
