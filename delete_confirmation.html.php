...
<div id="nav">
  ...
  <form action="?deletinguser" method="post" id="deleteconfirm">
    <h2 class="phpHeading">Are you sure you want to delete <?php echo $name[0]; ?>?</h2>
    <input type="hidden" name="id" value="<?php echo $_POST['id']; ?>">
    <input type="submit" value="Yes" name="delete" id="deleteYes">
    <input type="submit" value="No" name="delete" id="deleteNo">
  </form>
