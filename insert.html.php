...
<form action="?" method="post" id="insertform">
            <h2 class="phpHeading">Add new user information:</h2> 
            <p><a href="index.php" id="back">Go Back</a></p>
      <div>
        <label for="newfirstname">First Name:</label>
        <input type="text" id="newfirstname" name="newfirstname" value="<?php if(isset($_POST['newfirstname'])){echo $_POST['newfirstname'];} ?>"><span><?php echo $fname_err; ?></span>    
      </div>
      <div>
        <label for="newlastname">Last Name:</label>
        <input type="text" id="newlastname" name="newlastname" value="<?php if(isset($_POST['newlastname'])){echo $_POST['newlastname'];} ?>"><span><?php echo $lname_err; ?></span>     
      </div>
      <div>
        <label for="newemail">Email:</label>
        <input type="text" id="newemail" name="newemail" value="<?php if(isset($_POST['newemail'])){echo $_POST['newemail'];} ?>"><span><?php echo $email_err; ?></span>     
      </div>
      <div id="btns">
        <input type="submit" value="Add" id="addingUser">
      </div>
    </form>
